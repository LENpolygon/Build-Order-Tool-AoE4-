...
if (!selectedciv) {
window.location.href = "editor.html?c=EN&s=";
}
...
str += "><a href=\"editor.html?c=" + civilizations[i].abbr + "\">" + civilizations[i].civilization + "</a></li>";
}
...
window.history.replaceState("Home", "AGE OF EMPIRES 4 - BUILD ORDER TOOL", 'editor.html?c=' + selectedciv.abbr + "&s=" + LZString.compressToEncodedURIComponent(str));
...
if (buildorder) {
    ...
    window.history.replaceState("Home", "AGE OF EMPIRES 4 - BUILD ORDER TOOL", 'editor.html?c=' + selectedciv.abbr + "&b=" + str);
